...
namespace Hooker_GUI
{
    ...
    public partial class Startlista : FormBas
    {
        ...
        /// </summary>
        public DataSet StartlistaDS { get; set; }
        /// <summary>
        /// RondNr
        /// </summary>
        ...
        private void FyllListan()
        {
            ...
            {
                StartlistaDS = tavlingStartlistaAktivitet.HämtaStartlista(Tavling.TavlingID);

                if (StartlistaDS.Tables["Startlista"].Rows.Count > 0)
                {
                    FyllRonderCombo();
                }
            }
            ...
            foreach (DataRow rad in StartlistaDS.Tables["Startlista"].Rows)
            {
        ...
        private void knappkontroller1_OnKnapp3Click(object sender, EventArgs e)
        {
            ...
            foreach (TavlingStartlista rad in Tavling.TavlingStartlista)
            {
                ...
                tavlingStartlista.TaBort(Tavling, rad.RondID, rad.SpelareID, ref FelID, ref Feltext);
            }
        }
