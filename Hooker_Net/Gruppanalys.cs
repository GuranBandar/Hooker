            ...
            foreach (DataRow rad in _gruppanalysDS.Tables["Gruppanalys"].Rows)
            {
                switch (rad["Par"].ToString())
                {
                    case "3":
                        ...
                        txtPar3GRTraff.Text = ("N").Formatera(Functions.ToInt(rad["Antal GR"]));
                        txtPar3GRTraffProc.Text = ("ND1").Formatera(
                            decimal.Parse(Functions.ToInt(rad["Antal GR"]).ToString()) / 
                            decimal.Parse(Functions.ToInt(rad["Antal hål"]).ToString()) * 100);
                        txtPar3FWTraff.Text = ("N").Formatera(Functions.ToInt(rad["Antal FW"]));
                        txtPar3FWTraffProc.Text = ("ND1").Formatera(
                            decimal.Parse(Functions.ToInt(rad["Antal FW"]).ToString()) / 
                            decimal.Parse(Functions.ToInt(rad["Antal hål"]).ToString()) * 100);
                    ...
                    case "4":
                        ...
                        txtPar4Puttsnitt.Text = ("ND1").Formatera(
                            decimal.Parse(rad["Puttar"].ToString()) / decimal.Parse(rad["Antal hål"].ToString()));
                        txtPar4GRTraff.Text = ("N").Formatera(Functions.ToInt(rad["Antal GR"]));
                        txtPar4GRTraffProc.Text = ("ND1").Formatera(
                            decimal.Parse(Functions.ToInt(rad["Antal GR"]).ToString()) / 
                            decimal.Parse(Functions.ToInt(rad["Antal hål"]).ToString()) * 100);
                        txtPar4FWTraff.Text = ("N").Formatera(Functions.ToInt(rad["Antal FW"]));
                    ...
                    case "5":
                        ...
                        txtPar5Puttsnitt.Text = ("ND1").Formatera(
                            decimal.Parse(rad["Puttar"].ToString()) / decimal.Parse(rad["Antal hål"].ToString()));
                        txtPar5GRTraff.Text = ("N").Formatera(Functions.ToInt(rad["Antal GR"]));
                        txtPar5GRTraffProc.Text = ("ND1").Formatera(
                            decimal.Parse(Functions.ToInt(rad["Antal GR"]).ToString()) / 
                            decimal.Parse(Functions.ToInt(rad["Antal hål"]).ToString()) * 100);
                        txtPar5FWTraff.Text = ("N").Formatera(Functions.ToInt(rad["Antal FW"]));
                    ...
                    case "9":
                        ...
                        txtTotaltPuttsnitt.Text = ("ND1").Formatera(
                            decimal.Parse(rad["Puttar"].ToString()) / decimal.Parse(rad["Antal hål"].ToString()));
                        txtTotaltGRTraff.Text = ("N").Formatera(Functions.ToInt(rad["Antal GR"]));
                        txtTotaltGRTraffProc.Text = ("ND1").Formatera(
                            decimal.Parse(Functions.ToInt(rad["Antal GR"]).ToString()) / 
                            decimal.Parse(Functions.ToInt(rad["Antal hål"]).ToString()) * 100);
                        txtTotaltFWTraff.Text = ("N").Formatera(Functions.ToInt(rad["Antal FW"]));
