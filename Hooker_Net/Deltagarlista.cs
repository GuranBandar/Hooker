...
namespace Hooker_GUI
{
    ...
    public partial class Deltagarlista : FormBas
    {
        ...
        /// </summary>
        public DataSet DeltagarlistaDS
        {
            get
            {
                return _deltagarlistaDS;
            }
            set
            {
                _deltagarlistaDS = value;
            }
        }
        #endregion
        ...
        public void VisaDeltagarlista()
        {
            ...
            if (_deltagarlistaDS.Tables["Deltagarlista"].Rows.Count > 0 && Tavling.ÄrÖppenFörAnmälan())
            {
        ...
        private void FyllListan()
        {
            ...
            _deltagarlistaDS = tavlingDeltagareAktivitet.HämtaDeltagarlista(Tavling.TavlingID);
            int i = 0;
            dgwDeltagarlista.Rows.Clear();
            
            foreach (DataRow rad in _deltagarlistaDS.Tables["Deltagarlista"].Rows)
            {
        ...
        private void knappkontroller1_OnKnapp3Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (svar.Equals("Ja"))
                {
                    for (int i = 0; i < _deltagarlistaDS.Tables["Deltagarlista"].Rows.Count; i++)
                    {
