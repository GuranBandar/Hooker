    ...
    public partial class Rondanalys : FormBas
    {
        ...
        private void VisaResultat()
        {
            ...
            try
            {
                ...
                knappkontroller1.btnKnapp2.Enabled = false;
                //Antalet rundor
                txtAntal.Text = _rondanalysDS.Tables["Rondanalys"].Rows.Count.ToString();
                dgwRondanalys.Rows.Clear();

                if (_rondanalysDS.Tables["Rondanalys"].Rows.Count > 0)
                {
                    //Borja med att räkna ut alla snittresultat
                    for (int i = 0; i <= _rondanalysDS.Tables["Rondanalys"].Rows.Count - 1; i++)
                    {
                        snittSlagTot += int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Slag"].ToString());
                        snittSlagUt += int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Slag Ut"].ToString());
                        snittSlagIn += int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Slag In"].ToString());
                        snittPoangTot += int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Poäng"].ToString());
                        snittPoangUt += int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Poäng Ut"].ToString());
                        snittPoangIn += int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Poäng In"].ToString());
                    }
                    ...
                    dgwRondanalys.Rows[0].Cells["SummaSlag"].Value = 
                        ("ND1").Formatera(snittSlagTot / decimal.Parse(_rondanalysDS.Tables["Rondanalys"].Rows.Count.ToString()));
                    ...
                    dgwRondanalys.Rows[0].Cells["SlagUt"].Value =
                        ("ND1").Formatera(snittSlagUt / decimal.Parse(_rondanalysDS.Tables["Rondanalys"].Rows.Count.ToString()));
                    ...
                    dgwRondanalys.Rows[0].Cells["SlagIn"].Value =
                        ("ND1").Formatera(snittSlagIn / decimal.Parse(_rondanalysDS.Tables["Rondanalys"].Rows.Count.ToString()));
                    ...
                    dgwRondanalys.Rows[0].Cells["SummaPoang"].Value =
                        ("ND1").Formatera(snittPoangTot / decimal.Parse(_rondanalysDS.Tables["Rondanalys"].Rows.Count.ToString()));
                    ...
                    dgwRondanalys.Rows[0].Cells["PoangUt"].Value =
                        ("ND1").Formatera(snittPoangUt / decimal.Parse(_rondanalysDS.Tables["Rondanalys"].Rows.Count.ToString()));
                    ...
                    dgwRondanalys.Rows[0].Cells["PoangIn"].Value =
                        ("ND1").Formatera(snittPoangIn / decimal.Parse(_rondanalysDS.Tables["Rondanalys"].Rows.Count.ToString()));
                    ...
                    {
                        dgwRondanalys.Rows.Add();
                        dgwRondanalys.Rows[i + 1].Cells["RundaNr"].Value = _rondanalysDS.Tables["Rondanalys"].Rows[i]["RundaNr"].ToString();
                        dgwRondanalys.Rows[i + 1].Cells["GolfklubbNr"].Value = _rondanalysDS.Tables["Rondanalys"].Rows[i]["GolfklubbNr"].ToString();
                        dgwRondanalys.Rows[i + 1].Cells["Datum"].Value = ("STD").Formatera(DateTime.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Datum"].ToString()));
                        dgwRondanalys.Rows[i + 1].Cells["Bana"].Value = _rondanalysDS.Tables["Rondanalys"].Rows[i]["Golfklubb"].ToString()
                            + ", " + _rondanalysDS.Tables["Rondanalys"].Rows[i]["BanaNamn"].ToString();
                        dgwRondanalys.Rows[i + 1].Cells["SummaSlag"].Value = _rondanalysDS.Tables["Rondanalys"].Rows[i]["Slag"].ToString();
                        dgwRondanalys.Rows[i + 1].Cells["SummaSlag"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        dgwRondanalys.Rows[i + 1].Cells["SlagUt"].Value = _rondanalysDS.Tables["Rondanalys"].Rows[i]["Slag Ut"].ToString();
                        dgwRondanalys.Rows[i + 1].Cells["SlagUt"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        dgwRondanalys.Rows[i + 1].Cells["SlagIn"].Value = _rondanalysDS.Tables["Rondanalys"].Rows[i]["Slag In"].ToString();
                        dgwRondanalys.Rows[i + 1].Cells["SlagIn"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        dgwRondanalys.Rows[i + 1].Cells["SummaPoang"].Value = _rondanalysDS.Tables["Rondanalys"].Rows[i]["Poäng"].ToString();
                        dgwRondanalys.Rows[i + 1].Cells["SummaPoang"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        dgwRondanalys.Rows[i + 1].Cells["PoangUt"].Value = _rondanalysDS.Tables["Rondanalys"].Rows[i]["Poäng Ut"].ToString();
                        dgwRondanalys.Rows[i + 1].Cells["PoangUt"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        dgwRondanalys.Rows[i + 1].Cells["PoangIn"].Value = _rondanalysDS.Tables["Rondanalys"].Rows[i]["Poäng In"].ToString();
                        ...
                        if (int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Poäng"].ToString()) < 33)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["SummaPoang"].Style.ForeColor = Color.Blue;
                        }
                        else if (int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Poäng"].ToString()) > 36)
                        {
                        ...
                        dgwRondanalys.Rows[i + 1].Cells["ResEfter3"].Value =
                            6 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 3"].ToString());
                        dgwRondanalys.Rows[i + 1].Cells["ResEfter3"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        if (6 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 3"].ToString()) < 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter3"].Style.ForeColor = Color.Red;
                        }
                        else if (6 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 3"].ToString()) > 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter3"].Style.ForeColor = Color.Blue;
                        }

                        dgwRondanalys.Rows[i + 1].Cells["ResEfter6"].Value =
                             12 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 6"].ToString());
                        dgwRondanalys.Rows[i + 1].Cells["ResEfter6"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        if (12 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 6"].ToString()) < 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter6"].Style.ForeColor = Color.Red;
                        }
                        else if (12 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 6"].ToString()) > 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter6"].Style.ForeColor = Color.Blue;
                        }

                        dgwRondanalys.Rows[i + 1].Cells["ResEfter9"].Value =
                            18 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 9"].ToString());
                        dgwRondanalys.Rows[i + 1].Cells["ResEfter9"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        if (18 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 9"].ToString()) < 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter9"].Style.ForeColor = Color.Red;
                        }
                        else if (18 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 9"].ToString()) > 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter9"].Style.ForeColor = Color.Blue;
                        }

                        dgwRondanalys.Rows[i + 1].Cells["ResEfter12"].Value =
                            24 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 12"].ToString());
                        dgwRondanalys.Rows[i + 1].Cells["ResEfter12"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        if (24 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 12"].ToString()) < 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter12"].Style.ForeColor = Color.Red;
                        }
                        else if (24 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 12"].ToString()) > 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter12"].Style.ForeColor = Color.Blue;
                        }

                        dgwRondanalys.Rows[i + 1].Cells["ResEfter15"].Value =
                            30 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 15"].ToString());
                        dgwRondanalys.Rows[i + 1].Cells["ResEfter15"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        if (30 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 15"].ToString()) < 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter15"].Style.ForeColor = Color.Red;
                        }
                        else if (30 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 15"].ToString()) > 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter15"].Style.ForeColor = Color.Blue;
                        }

                        dgwRondanalys.Rows[i + 1].Cells["ResEfter18"].Value =
                            36 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 18"].ToString());
                        dgwRondanalys.Rows[i + 1].Cells["ResEfter18"].Style.Alignment =
                            System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
                        if (36 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 18"].ToString()) < 0)
                        {
                            dgwRondanalys.Rows[i + 1].Cells["ResEfter18"].Style.ForeColor = Color.Red;
                        }
                        else if (36 - int.Parse(_rondanalysDS.Tables["Rondanalys"].Rows[i]["Res efter 18"].ToString()) > 0)
                        {
        ...
        {
            if (_rondanalysDS != null)
            {
                hanteraFönster1.HanteraVisaFormkurva(_rondanalysDS);
            }
        }
        ...
        private void knappkontroller1_OnKnapp3Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _rondanalysDS = statistik.Rondanalys(golfklubbNr, banaNr, spelarID.ToString(), fromDatum, tomDatum,
